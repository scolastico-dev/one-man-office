...
| `omo context save [summary]` | One concise summary argument or stdin; maximum 8000 characters | During safe shutdown, persist completed work, remaining work, blockers, and the exact next step. The matching role/job receives it on the next office run, after which it is deleted. |
