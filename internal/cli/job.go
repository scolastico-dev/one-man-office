	...
	show := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			fmt.Fprintf(cmd.OutOrStdout(),
				...
				strings.Join(j.DeveloperModels, ","), j.ForceDeveloperModel, j.Note, j.Result, formatIntegrationBranches(j.IntegrationBranches), formatPullRequests(j.PullRequests), j.Goal)
			return nil
		},
	}
