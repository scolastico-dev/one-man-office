...
func commandCatalog() []commandSpec {
	...
	return []commandSpec{
		...
		{Title: "Office: halt spawns", Path: "office halt-spawns", Help: "Halt new work and smoke-alarm spawns; an active round may file an incident, and firefighters may respond during an ordinary halt."},
		{Title: "Office: resume spawns", Path: "office resume-spawns", Help: "Resume work and smoke-alarm spawns; exits safe mode if active."},
