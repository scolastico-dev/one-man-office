...
- Successful usage checks replace canonical provider rows in `model_usage_snapshots`; profiles sharing a credential scope reuse one fetch, leaving only Claude weekly/session and Codex weekly values in the TUI.
